...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/tanmayy91/Convx/workflows/nightly.yml/main/convx-gms-nightly.zip"
        } else {
            "https://github.com/tanmayy91/Convx/releases/download/$versionName/convx-$versionName.apk"
        }
